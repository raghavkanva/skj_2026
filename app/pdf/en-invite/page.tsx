      ...
      <div className={styles.page3}>
        ...
        <div className={styles.staySection}>
          ...
          <p className={styles.staySub}>
            To know more about our temple, Bhagavad Gita classes and
            upcoming festivals, click below:
          </p>
          ...
          <p className={styles.trustLine}>
            <strong>Safe to open:</strong> This link contains only our
            official YouTube, WhatsApp &amp; Facebook links.
          </p>
        </div>
